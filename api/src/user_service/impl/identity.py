...
Extracted from `UsersApiImpl._require_user_id` (which now delegates here) so other impls — e.g.
`EarlyAccessApiImpl` — don't need to import a sibling impl class just to resolve the caller's
identity.
"""

...
class TestDatabaseQuery(unittest.TestCase):
    def setUp(self):
        self._FEED_ID_1 = "FEED_1"
        self._FEED_ID_2 = "FEED_2"
        self._FEED_ID_3 = "FEED_3"
        self._FEED_ID_4 = "FEED_4"

        self.db = Database()

        # setting stable_id to be same as id for testing purposes
        self.db.merge(Gtfsfeed(id=self._FEED_ID_1, stable_id=self._FEED_ID_1))
        self.db.merge(Gtfsfeed(id=self._FEED_ID_2, stable_id=self._FEED_ID_2))
        self.db.merge(Gtfsfeed(id=self._FEED_ID_3, stable_id=self._FEED_ID_3))
        self.db.merge(Gtfsfeed(id=self._FEED_ID_4, stable_id=self._FEED_ID_4))

...
class TestExtractBoundingBox(unittest.TestCase):
    def test_parse_resource_data(self):
        ...
        self.assertIn(stable_id, resource_name)
        self.assertIn(dataset_id, resource_name)
        expected_url = f"https://storage.googleapis.com/{bucket_name}/{stable_id}/{dataset_id}/{file_name}"

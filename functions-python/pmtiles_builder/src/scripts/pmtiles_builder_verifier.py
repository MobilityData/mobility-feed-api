...
from csv_cache import STOP_TIMES_FILE, SHAPES_FILE, TRIPS_FILE, ROUTES_FILE, STOPS_FILE, AGENCY_FILE
from main import build_pmtiles_handler
from shared.helpers.verifier_common import create_test_data, setup_local_storage_emulator, \
    shutdown_local_storage_emulator, EMULATOR_STORAGE_BUCKET_NAME, download_to_local

feeds = [
    {"stable_id": "mdb-437", "dataset_stable_id": "mdb-437-202509111534"},
]
...
def download_feed_files(feed_stable_id: str, dataset_stable_id: str):
    FILES_URL = "https://files.mobilitydatabase.org"
    ...
    for file in FILES:
        ...
        try:
            download_to_local(feed_stable_id, url, filename)

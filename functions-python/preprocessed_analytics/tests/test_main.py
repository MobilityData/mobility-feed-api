...
class TestAnalyticsFunctions(unittest.TestCase):
    @patch("preprocessed_analytics.src.main.preprocess_analytics_gtfs")
    @patch("preprocessed_analytics.src.main.preprocess_analytics_gbfs")
    ...
    @patch("preprocessed_analytics.src.main.preprocess_analytics")

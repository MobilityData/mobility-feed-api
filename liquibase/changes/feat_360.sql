-- Dropping the materialized view as it depends on GtfsDataset.downloaded_at column
DROP MATERIALIZED VIEW IF EXISTS FeedSearch;

ALTER TABLE GtfsDataset
    ALTER COLUMN downloaded_at TYPE TIMESTAMP WITH TIME ZONE;

ALTER TABLE ValidationReport
    ALTER COLUMN validated_at TIMESTAMP WITH TIME ZONE;

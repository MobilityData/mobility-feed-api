...
export const GtfsVisualizationMap = ({
  ...
  const stopsUrl = `pmtiles://https://storage.googleapis.com/mobilitydata-datasets-dev/${feedStableId}/${datasetStableId}/pmtiles/stops.pmtiles`;
  const routesUrl = `pmtiles://https://storage.googleapis.com/mobilitydata-datasets-dev/${feedStableId}/${datasetStableId}/pmtiles/routes.pmtiles`;

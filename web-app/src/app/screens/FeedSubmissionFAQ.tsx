      ...
      >
        <Accordion sx={accordionStyle}>
         ...
         >
          ...
          <AccordionDetails>
                      <Typography>
                        If you want to add GBFS feeds to the Mobility Database, please contribute to
                         <Button
                                        variant='text'
                                        className='inline'
                                        href={'https://github.com/MobilityData/gbfs?tab=readme-ov-file#systems-catalog---systems-implementing-gbfs'}
                                        rel='noreferrer'
                                        target='_blank'

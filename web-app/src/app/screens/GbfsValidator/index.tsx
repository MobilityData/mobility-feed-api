    ...
    <Box>
      ...
      >
       <Box sx={{ position: 'absolute',
            top: '-110px',
            left: '50%',
            transform: 'translateX(-50%)',            maxWidth: 'md',
            margin: 'auto',}}>
       <Box
          id='input-box'
          sx={{
          ...
          >
            <Box sx={{ width: '60%' }}>
              ...
              <Typography>
                ...
                and is designed to help you validate your GBFS feeds against the
                GBFS specification. For more information about GBFS or the official
                GBFS JSON schema, please visit
              </Typography>
              <Box sx={{mt: 2, display: 'flex', gap: 2}}>
                <Button variant='outlined' endIcon={<OpenInNew />}>GBFS Schema Repository</Button>
                <Button variant='outlined' endIcon={<OpenInNew />}>GBFS.org</Button>
              </Box>
            </Box>
            <Box sx={{width: '35%',textAlign: 'center'}}>
                <Box sx={{width: '200px'}} component={'img'} src={gbfsLogo}></Box>
            </Box>
          </Box>
          <Box
            id='row'
          ...
          >
            <Box sx={{ width: '60%', maxWidth: '30em' }}>
              ...
              <Typography>
                ...
                contributions from the community. Special thanks to <a>Tom Erik</a>
              </Typography>
              <Box sx={{mt: 2}}>
                <Button variant='outlined' endIcon={<OpenInNew />}>View Github Repository</Button>
              </Box>
            </Box>
            <Box sx={{width: '35%', textAlign: 'center'}}>
                <Box sx={{width: '200px'}} component={'img'} src={githubLogo}></Box>
            </Box>
          </Box>
        </Box>
        ) : (
